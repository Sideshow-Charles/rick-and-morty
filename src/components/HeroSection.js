...
const HeroSection = () => {
    return (
        <div>
            <p className="font-indie text-6xl text-emerald-400 mt-48 ml-16 mr-16">CHECK OUT LOCATIONS, CHARACTERS AND EPISODES OF YOUR FAVORITE TV SHOW, RICK & MORTY<br></br> Wubba Lubba Dub Dub!</p>
